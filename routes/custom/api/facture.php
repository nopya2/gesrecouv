...
Route::middleware('auth:api')->patch('factures/{facture}/relaunch', 'FactureController@relaunch'); //Relancer une facture
...
Route::middleware('auth:api')
    ->get('factures/{facture}/relaunches', 'FactureController@relaunches'); //Relancer une facture